  ...
  return (
    <div className="flex flex-1 border-t border-[#DAC895] ">
      <div className="my-2 w-2/12 ">
        <img src={item.images[0].url} alt="imagen" width="100px" />
      </div>
      ...
      <div className="flex  mt-4  text-lg w-1/12 justify-end	">
        <div>
          <span className="font-bold">{quantity * item.price} €</span>
          <div
            className=" flex mt-4 justify-end"
            onClick={RemoveItemHandleClick}
          >
