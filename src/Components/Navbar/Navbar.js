...
const Navbar = (props) => {
  return (
    <div>
      <div className="flex flex-row flex-1 border-b h-6	" style={{backgroundColor:"#dac895"}} >
     
      <div className="flex flex-1 w-3/5 justify-center text-white	">
        <span>Promocion verano 25% descuento</span>
      </div>
      
    </div>
    <div className="flex flex-row flex-1 border-b " /* style={{backgroundColor:"#dac895"}}  */>
      <div className=" p-8 	">
      ...
      <div className="flex flex-1 	align-middle	p-12 justify-center">
